...
app.get('/patients', (req, res) => {
    const query = `
        SELECT p.patient, 
            ...
            CASE 
                ...
                WHEN r.eGFR BETWEEN 45 AND 59 AND r.uACR < 30 THEN 'Moderate Risk (G3a-A1)'
                WHEN r.eGFR BETWEEN 45 AND 59 AND r.uACR BETWEEN 30 AND 300 THEN 'High Risk (G3a-A2)'
                WHEN r.eGFR BETWEEN 45 AND 59 AND r.uACR > 300 THEN 'Very High Risk (G3a-A3)'

                WHEN r.eGFR BETWEEN 30 AND 44 AND r.uACR < 30 THEN 'High Risk (G3b-A1)'
                WHEN r.eGFR BETWEEN 30 AND 44 AND r.uACR BETWEEN 30 AND 300 THEN 'Very High Risk (G3b-A2)'
                WHEN r.eGFR BETWEEN 30 AND 44 AND r.uACR > 300 THEN 'Very High Risk (G3b-A3)'

                WHEN r.eGFR BETWEEN 15 AND 29 AND r.uACR < 30 THEN 'Very High Risk (G4-A1)'
                WHEN r.eGFR BETWEEN 15 AND 29 AND r.uACR BETWEEN 30 AND 300 THEN 'Very High Risk (G4-A2)'
                WHEN r.eGFR BETWEEN 15 AND 29 AND r.uACR > 300 THEN 'Very High Risk (G4-A3)'

                WHEN r.eGFR < 15 THEN 'Kidney Failure (G5)'
                ELSE 'Unknown Risk'
    ...
    db.all(query, [], (err, rows) => {
        ...
        res.json(rows); // Return all patients as an array
    });
});
